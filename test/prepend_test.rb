...
class PrependTest < Minitest::Test
  def test_setting_explicitly_by_file_a
    result = TLDRunner.should_succeed ["prepend/a.rb", "prepend/b.rb"], "--prepend test/fixture/prepend/a.rb --seed 1"

    assert_these_appear_before_these result.stdout, ["A1", "A2", "A3"], ["B1", "B2", "B3"]
  end

  def test_setting_explicitly_by_line_number
    result = TLDRunner.should_succeed ["prepend/a.rb", "prepend/b.rb"], "--prepend test/fixture/prepend/a.rb:7 --seed 1"

    assert_these_appear_before_these result.stdout, ["A2"], ["A1", "A3", "B1", "B2", "B3"]
  end

  def test_setting_explicitly_by_multiple
    result = TLDRunner.should_succeed ["prepend/a.rb", "prepend/b.rb"], "--prepend test/fixture/prepend/a.rb:3:12 --prepend test/fixture/prepend/b.rb:8 --seed 1"

    assert_these_appear_before_these result.stdout, ["A1", "A3", "B2"], ["A2", "B1", "B3"]
  end

  def test_setting_explicitly_by_file_b
    result = TLDRunner.should_succeed ["prepend/a.rb", "prepend/b.rb"], "--prepend test/fixture/prepend/b.rb --seed 1"
  ...
  def test_modifying_a_prepends_a_by_default
    ...
    result = TLDRunner.should_succeed ["prepend/a.rb", "prepend/b.rb"], "--seed 1"
  ...
  def test_no_prepend_does_not_prepend
    ...
    result = TLDRunner.should_succeed ["prepend/a.rb", "prepend/b.rb"], "--seed 1 --no-prepend"
